<?php $this->title = "Admin : Créer un épisode"; ?>
<section id="intro">
    <div class="container">
        <h1>Créer un nouvel épisode</h1>
    </div>
</section>
<section id="main-admin">
    <div class="container">
        ...
        <article id="main-col">
            <h3>Détails de cet épisode :</h3>
            <form action="admin/enregistrer" method="post">
                ...
                <p>
                    ...
                    <?php if (isset($errors['err_episode'])): ?>
