            ...
            <ul id="bio">
                <li>
                    ...
                    <p>Luke Maddison, jeune et richissime financier s’apprête à épouser Margaret Leferre, son amie d’enfance. 
                        ...
                        le responsable de ses revers. Margaret doit-elle le croire ? Et Danton Morell, l’ami de Margaret, ne 
                        manque pas une occasion, lui aussi, de noircir son fiancé.</p>
                    <p>Pour Luke, cependant, la situation vire au cauchemar : 
                        pris au piège, il est ruiné, victime d’une agression dans les bas-fonds de Londres et confronté à la pègre locale. 
                        C’est alors qu’apparaît Haynes «le Tueur,» un voleur de bijoux. Son aide sera décisive, ainsi que 
                        celle de l'inspecteur Malineaux dit «Le Moineau», pour résoudre les mystères de cette affaire.</p>
                ...
                <li>
                    ...
                    <p>Chaque jour, comme un devoir, Ben rend visite aux marginaux et aux exilés du désert : 
                        il y a Walt, le propriétaire octogénaire du " never open diner ", le seul diner de la route 117, 
                        qui n'a pas ouvert depuis des années.</p>
                    <p>Il y a Fergus et Ducan, deux frères qui vivent dans des wagons abandonnés. Il y a aussi John, 
                        un illuminé qui traîne tous les étés une croix grande comme lui dans le désert.</p>
                    <p>Au milieu de cette cour des miracles, Ben Jones a la désagréable impression de revivre inlassablement 
                        la même journée, jusqu'à ce qu'il croise Claire, une très belle violoncelliste dont il tombe amoureux.</p>
                    <p>Mais qui est-elle réellement ? Que fuit-elle ? Son ex-mari, comme elle le laisse entendre ? 
                        Ou bien autre chose, de bien plus dangereux ?</p>
                    <p>Ben se méfie, car il sait que dans le désert, les choses sont plus complexes qu'elles n'y paraissent... </p>
                ...
                <li>
                    ...
                    <p>Arrivée en France, ce qu’elle découvre n’est pas la liberté, plutôt l’injustice et la brutalité des hommes. 
                        Prise dans l’engrenage de la violence et de ce qu’elle croit être la légitime défense, Meryl devient la criminelle 
                        la plus recherchée du pays.</p>
                    <p>L'inspecteur Malineaux remonte une route jonchée de cadavres, loin de se douter que cette folie meurtrière est 
                        l'oeuvre d’une femme.</p>
